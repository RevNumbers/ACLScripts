#!/bin/bash
grep 'ASA-6-302013' VAL-CISCO-5525-P1 | awk '{print $8,$13,$16}' | awk -F":" '{print $1,$2,$3}' | awk -F"/" '{print $1,$2,$3" tcp"}' > VAL-CISCO-5525-P1_inout
grep 'ASA-6-302015' VAL-CISCO-5525-P1 | awk '{print $8,$13,$16}' | awk -F":" '{print $1,$2,$3}' | awk -F"/" '{print $1,$2,$3" udp"}' >> VAL-CISCO-5525-P1_inout
